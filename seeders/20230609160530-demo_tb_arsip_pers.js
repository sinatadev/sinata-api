  ...
  const arsipPers = [
    {
      ...
      admin: 'Super Admin',
      link_berita:
        'https://uns.ac.id/id/uns-update/prodi-ppkn-uns-gelar-seminar-nasional-bahas-pendidikan-kewarganegaraan-untuk-penguatan-karakter-bangsa.html',
      judul_terjemahan:
